...
#> ✔ Wrote /tmp/RtmpNI9t83/file1bca4d49ecd9.docx (21 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc form check ───────────────────────────────────────────────────────────
#> File: /tmp/RtmpNI9t83/file1bca4d49ecd9.docx
...
#> ✔ Wrote /tmp/RtmpNI9t83/file1bca6445ac1e.lss (20 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc audit ────────────────────────────────────────────────────────────────
#> File: /tmp/RtmpNI9t83/file1bca6445ac1e.lss
#> Languages: "en"
...
#> ✔ Wrote /tmp/RtmpNI9t83/file1bca5a1235ab.docx (43 questions, 6 groups, 1 quota).
```
