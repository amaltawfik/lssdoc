...
#> ✔ Wrote /tmp/RtmpKjYNhB/file1bfe2d2e07f5.docx (21 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc form check ───────────────────────────────────────────────────────────
#> File: /tmp/RtmpKjYNhB/file1bfe2d2e07f5.docx
...
#> ✔ Wrote /tmp/RtmpKjYNhB/file1bfe2f4b3ea3.lss (20 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc audit ────────────────────────────────────────────────────────────────
#> File: /tmp/RtmpKjYNhB/file1bfe2f4b3ea3.lss
#> Languages: "en"
...
#> ✔ Wrote /tmp/RtmpKjYNhB/file1bfe3162a28e.docx (43 questions, 6 groups, 1 quota).
```
