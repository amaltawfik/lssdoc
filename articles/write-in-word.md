...
#> ✔ Wrote /tmp/RtmpWr9GZK/file1bf5381c8480.docx (21 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc form check ───────────────────────────────────────────────────────────
#> File: /tmp/RtmpWr9GZK/file1bf5381c8480.docx
...
#> ✔ Wrote /tmp/RtmpWr9GZK/file1bf5123a8623.lss (20 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc audit ────────────────────────────────────────────────────────────────
#> File: /tmp/RtmpWr9GZK/file1bf5123a8623.lss
#> Languages: "en"
...
#> ✔ Wrote /tmp/RtmpWr9GZK/file1bf559bdae56.docx (43 questions, 6 groups, 1 quota).
```
