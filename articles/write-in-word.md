...
#> ✔ Wrote /tmp/RtmpUwHkMM/file1b1e7e53935b.docx (21 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc form check ───────────────────────────────────────────────────────────
#> File: /tmp/RtmpUwHkMM/file1b1e7e53935b.docx
...
#> ✔ Wrote /tmp/RtmpUwHkMM/file1b1e5ec24723.lss (20 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc audit ────────────────────────────────────────────────────────────────
#> File: /tmp/RtmpUwHkMM/file1b1e5ec24723.lss
#> Languages: "en"
...
#> ✔ Wrote /tmp/RtmpUwHkMM/file1b1e4c3d66a4.docx (43 questions, 6 groups, 1 quota).
```
