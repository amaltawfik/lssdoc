...
#> ✔ Wrote /tmp/Rtmp2K0ToN/file1c0b2d8f70d3.docx (21 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc form check ───────────────────────────────────────────────────────────
#> File: /tmp/Rtmp2K0ToN/file1c0b2d8f70d3.docx
...
#> ✔ Wrote /tmp/Rtmp2K0ToN/file1c0b1defc59e.lss (20 questions, 2 groups, 1 quota).
```
...
#> 
#> ── lssdoc audit ────────────────────────────────────────────────────────────────
#> File: /tmp/Rtmp2K0ToN/file1c0b1defc59e.lss
#> Languages: "en"
...
#> ✔ Wrote /tmp/Rtmp2K0ToN/file1c0bb7fb8df.docx (43 questions, 6 groups, 1 quota).
```
