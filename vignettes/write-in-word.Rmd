...
so it cannot disagree with what `read_form_docx()` accepts. `label` is
the wording shown in review documents; `type`/`theme` are what LimeSurvey
stores.

```{r kinds, echo = FALSE}
knitr::kable(lssdoc:::lss_kinds_reference())
```
