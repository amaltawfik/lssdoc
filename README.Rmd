...
(`.docx`) or PDF questionnaire document for ethics committees,
survey methodologists, and translators. It renders the
...
- **Variable-centric compound rendering.** Array, multiple-choice,
  multiple-numerical and dual-scale array questions are documented
  per subquestion, with the real variable code (`parent_subq`) on
  the meta row -- not the parent code which never appears in the
  data export.
