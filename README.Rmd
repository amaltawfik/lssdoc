...
- **`"table"`** -- one dense codebook table covering the whole
  ...
  answer codes and their labels per language. Group banners,
  welcome text, description and end text become labelled rows of
  the same table so the codebook reads as a single artifact.
...
Use `citation("lssdoc")` once the package is on CRAN, or cite the
GitHub repository in the meantime:
