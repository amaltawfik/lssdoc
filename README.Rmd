...
side by side in up to four languages, runs an automated integrity
audit, and produces a layout that reads as a published codebook --
...
order. `chrome_lang` is independent: pass `"en"` to keep an
English-labeled scaffolding with French and German content side by
side.
