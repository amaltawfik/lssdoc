...
- **Automated audit.** Missing translations, unreachable filter
  expressions, dangling references, structural inconsistencies
  -- all flagged inline on the rendered item and, when you ask
  for it, in a dedicated section. No AI; rule-based and
  reviewable.
