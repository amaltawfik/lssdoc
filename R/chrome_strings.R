...
lss_chrome_strings <- function(lang = "en") {
  base <- list(
    ...
    value_order_random                = "(random order)",
    value_order_alphabetical          = "(alphabetical order)",
  ...
  fr <- list(
    ...
    value_order_random                = "(ordre al\u00e9atoire)",
    value_order_alphabetical          = "(ordre alphab\u00e9tique)",
  ...
  de <- list(
    ...
    value_order_random                = "(Zufallsreihenfolge)",
    value_order_alphabetical          = "(alphabetische Reihenfolge)",
  ...
  es <- list(
    ...
    value_order_random                = "(orden aleatorio)",
    value_order_alphabetical          = "(orden alfab\u00e9tico)",
  ...
  it <- list(
    ...
    value_order_random                = "(ordine casuale)",
    value_order_alphabetical          = "(ordine alfabetico)",
