...
- [`read_form_docx()`](https://amaltawfik.github.io/lssdoc/reference/read_form_docx.md)
  **\[experimental\]** : Read a Word authoring form back into a survey
  specification

- [`check_form_docx()`](https://amaltawfik.github.io/lssdoc/reference/check_form_docx.md)
  [`print(`*`<lss_form_check>`*`)`](https://amaltawfik.github.io/lssdoc/reference/check_form_docx.md)
  **\[experimental\]** : Report every problem of a Word authoring form
  at once
