...
and orphan structural references. Questionnaires can also be written the
other way round: describe one in R, or fill in a Word form, and write an
importable '.lss' file. Designed for anyone working with a 'LimeSurvey'
